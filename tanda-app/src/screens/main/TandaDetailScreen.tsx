                ...
                >
                  {isDepositing ? (
                    ...
                    <Text style={styles.payNowButtonText}>
                      Pagar {formatEuro(nextPayment.amount + TANDA_CONFIG.commission)}
                    </Text>
                  )}
                </TouchableOpacity>
                <Text style={styles.commissionNote}>
                  Incluye €{TANDA_CONFIG.commission.toFixed(2)} de comisión
                </Text>
              </View>
            )}
